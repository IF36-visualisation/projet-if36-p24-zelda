...
unique de chaque chanson pour récupérer sa date de sortie grâce à l'API
Spotify et la bibliothèque spotifyr de R.
...
df_q1_agg %>% 
    ...
    geom_mark_hull(aes(filter = annee_group == "2022",
                        label = '2022',
                        description = 'presque 1/4 des titres sortis en 2022'),
                   fill = NA,
                   color = NA) +
    labs(x = NULL,
         y = NULL,
