...
Rappel : Les valeurs possibles pour la variable 'Album_type' sont album,
single et compilation.

Variables : 'Streams', 'Views', 'Album_type', 'Likes', 'Comments'

Objectif : Comparaison avec valeurs discrètes et nominales (album_type).
...
-   Le format des single cherche plus à apporter de l'engouement pour un
...
Après tous les questions et recherches précédentes et par l'expérience dans la vie quotidienne, 
on peut déjà avoir une hypothèse que certain variable quantitatifs peuvent avoir une corrélation 
avec les autres. Le but de cette question est d'essayer faire une analyse et quantifier ces 
