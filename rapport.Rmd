...
Les deux première composantes représentent environ 45 % d'inertie, nous pouvons donc dire que cette représentation n'est pas très idéal. Nous regardons ensuite le cercle de corrélation :
...
Si on faire une combinaison du résultat de CAH et le cercle de corrélation, on trouve que les groupes de variable dans le cercle de corrélation nous permettent de décrire les clusters.
...
Cluster 5 : 0
Cluster 6 : 0  
Donc on trouve les attributs liés au ce groupe :
Dancablity, Valence, Loudness, Energy, Tempo, Liveness
Ces caractères correspondent bien notre impression de "AC/DC" ! 
